    ...
    content:
      ...
      items:
        - name: "Carly Strasser"
          ...
          text: |
            Estoy impresionada por la profesionalidad, la consideración y la amabilidad de todo el equipo de MetaDocencia. Ha sido un placer poder trabajar con ustedes. (Tras co-organizar el [primer evento de CZI Open Science en Latinoamérica](https://chanzuckerberg.com/blog/open-science-latin-america-argentina/).)
        - name: "Julio Zetter"
