    ...
    content:
      ...
      items:
        - name: "Carly Strasser"
          ...
          text: |
            Estoy impresionada por la profesionalidad, la consideración y la amabilidad de todo el equipo de MetaDocencia. Ha sido un placer poder <a href="https://chanzuckerberg.com/blog/open-science-latin-america-argentina/" style="text-decoration: underline; text-underline-offset: 0.15em; text-decoration-thickness: 1.5px;">trabajar</a> con ustedes.
        - name: "Julio Zetter"
