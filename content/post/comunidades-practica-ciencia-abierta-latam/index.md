---
title: Comunidades de práctica y su influencia en la difusión de la ciencia abierta
  en Latinoamérica
summary: En esta publicación hacemos una primera aproximación a responder cuál es
  el rol de las comunidades de práctica en la difusión e implementación de prácticas
  de ciencia abierta en general, y específicamente, en la región de Latinoamérica.
date: '2023-04-28'
tags:
- MetaDocencia
categories:
...
- mrajngewerc
- patriloto
translationKey: comunidades-practica-ciencia-abierta-latam
---
...
![Gráfico que muestra las búsquedas de términos en tweets.](/img/cp-ca/grafico2.png)
...
![Gráficos que muestran promedio de retweets, porcentaje de tweets originales, porcentaje de cuentas influyentes y promedio de centralidad de intermediación.](/img/cp-ca/grafico3.png)
*Fuente: elaboración propia.*
...
![El gráfico muestra la cantidad de seguidores que comparten las comunidades de práctica estudiadas a través del ancho de las curvas que las conectan.](/img/cp-ca/grafico4.png)
*Fuente: elaboración propia.*
...
![El gráfico muestra la vinculación entre comunidades de práctica estudiadas.](/img/cp-ca/grafico5.png)
*Fuente: elaboración propia.*
