    ...
    content:
      ...
      text: |
        <style>
          ...
          /* ===== Botón blanco con texto NARANJA (para "Suma tu comunidad") ===== */
          .mdnv-btn-white-orange {
            ...
            border-radius: .5rem;
            background: #FFFFFF;
            color: #F77B20 !important;   /* texto naranja bien visible */
    ...
    content:
      ...
      text: |
        <details class="mdnv-collapsible">
          ...
          <!-- Botón: Suma tu comunidad (texto naranja sobre botón blanco) -->
          <div class="mt-3">
