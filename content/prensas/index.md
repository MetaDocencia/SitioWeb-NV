  ...
  <div id="press-list" class="mt-6 divide-y divide-gray-200 dark:divide-gray-800">
    ...
    <article class="py-6">
      <div class="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
        <!-- Fecha -->
        <time class="sm:w-28 shrink-0 text-sm text-gray-500 dark:text-gray-400 sm:mt-1">2023-06-26</time>

        <!-- Contenido -->
        <div class="min-w-0">
          <div class="flex items-center gap-2 mb-1">
            <img src="/media/prensa/iprofesional.jpg" alt="iProfesional" class="h-8 object-contain" loading="lazy">
            <span class="text-sm text-gray-500 dark:text-gray-400">iProfesional</span>
          </div>
    ...
    <article class="py-6">
      <div class="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
        <time class="sm:w-28 shrink-0 text-sm text-gray-500 dark:text-gray-400 sm:mt-1">2023-06-24</time>
        <div class="min-w-0">
          <div class="flex items-center gap-2 mb-1">
            <img src="/media/prensa/lacapital.jpg" alt="La Capital" class="h-8 object-contain" loading="lazy">
            <span class="text-sm text-gray-500 dark:text-gray-400">La Capital</span>
          </div>
    ...
    <article class="py-6">
      <div class="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
        <time class="sm:w-28 shrink-0 text-sm text-gray-500 dark:text-gray-400 sm:mt-1">2023-05-05</time>
        <div class="min-w-0">
          <div class="flex items-center gap-2 mb-1">
            <img src="/media/prensa/iprofesional.jpg" alt="iProfesional" class="h-8 object-contain" loading="lazy">
            <span class="text-sm text-gray-500 dark:text-gray-400">iProfesional</span>
    ...
    <article class="py-6">
      <div class="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
        <time class="sm:w-28 shrink-0 text-sm text-gray-500 dark:text-gray-400 sm:mt-1">2023-04-25</time>
        <div class="min-w-0">
          <div class="flex items-center gap-2 mb-1">
            <img src="/media/prensa/infobae.jpg" alt="Infobae" class="h-8 object-contain" loading="lazy">
            <span class="text-sm text-gray-500 dark:text-gray-400">Infobae</span>
          </div>
    ...
    <article class="py-6">
      <div class="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
        <time class="sm:w-28 shrink-0 text-sm text-gray-500 dark:text-gray-400 sm:mt-1">2022-08-13</time>
        <div class="min-w-0">
          <div class="flex items-center gap-2 mb-1">
            <img src="/media/prensa/perfil.jpg" alt="Diario Perfil" class="h-8 object-contain" loading="lazy">
            <span class="text-sm text-gray-500 dark:text-gray-400">Diario Perfil</span>
          </div>
    ...
    <article class="py-6">
      <div class="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
        <time class="sm:w-28 shrink-0 text-sm text-gray-500 dark:text-gray-400 sm:mt-1">2020-05-09</time>
        <div class="min-w-0">
          <div class="flex items-center gap-2 mb-1">
            <img src="/media/prensa/hospitalitaliano.png" alt="Revista Innova Salud Digital - Hospital Italiano" class="h-8 object-contain" loading="lazy">
            <span class="text-sm text-gray-500 dark:text-gray-400">Revista Innova Salud Digital - Hospital Italiano</span>
          </div>
    ...
    <article class="py-6">
      <div class="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
        <time class="sm:w-28 shrink-0 text-sm text-gray-500 dark:text-gray-400 sm:mt-1">2020-04-22</time>
        <div class="min-w-0">
          <div class="flex items-center gap-2 mb-1">
            <img src="/media/prensa/defrentealcampo.jpg" alt="INTA Anguil" class="h-8 object-contain" loading="lazy">
            <span class="text-sm text-gray-500 dark:text-gray-400">INTA Anguil</span>
          </div>
    ...
    <article class="py-6">
      <div class="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
        <time class="sm:w-28 shrink-0 text-sm text-gray-500 dark:text-gray-400 sm:mt-1">2020-04-07</time>
        <div class="min-w-0">
          <div class="flex items-center gap-2 mb-1">
            <img src="/media/prensa/eldocetv.jpg" alt="eldoce.tv" class="h-8 object-contain" loading="lazy">
            <span class="text-sm text-gray-500 dark:text-gray-400">eldoce.tv</span>
          </div>
    ...
    <article class="py-6">
      <div class="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
        <time class="sm:w-28 shrink-0 text-sm text-gray-500 dark:text-gray-400 sm:mt-1">2020-04-13</time>
        <div class="min-w-0">
          <div class="flex items-center gap-2 mb-1">
            <img src="/media/prensa/lapampanoticias.jpg" alt="La Pampa Noticias" class="h-8 object-contain" loading="lazy">
            <span class="text-sm text-gray-500 dark:text-gray-400">La Pampa Noticias</span>
          </div>
...
<style>
  /* Alineación del logo del medio: coherente con altura de línea */
  #press-list img { display:inline-block; vertical-align:middle; }
