  ...
  - block: features
    ...
    content:
      ...
      items:
        ...
        - name: "Integrity"
          description: "To act according to these values, building and sustaining trust through openness and transparency (with attention to privacy) and accountability for our actions."
        - name: "Education"
          description: "To contribute to the progress of society through community and individual learning."
        - name: "Wellbeing"
          description: "To treat others with kindness, empathy, and respect. We seek to understand each other and prioritize mental and physical health to maintain a healthy and safe work environment."
        - name: "Diversity"
        ...
        - name: "Autonomy"
          description: "To act responsibly according to individual, collective, and regional needs and contexts."
        - name: "Versatility"
        ...
        <div class="max-w-4xl mx-auto space-y-5 text-lg">
          ...
          <div>
            ...
            <p>
              ...
              <a href="https://zenodo.org/records/10514982" target="_blank" rel="noopener" class="underline font-semibold">Accessibility Policy (in spanish)</a>
